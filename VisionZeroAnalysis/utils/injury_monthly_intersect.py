...
#write header
out_header = ('NODEID','Lon','Lat','MN','YR','Injuries_COUNT','PedInjurie_COUNT','BikeInjuri_COUNT','MVOInjurie_COUNT','Injuries','PedInjurie','BikeInjuri', 'MVOInjurie')
...
for row in reader:
    ...
    if node_id in df.index:
        try:
            ...
            writer.writerow((node_id, lon, lat, mon, yr, inj_count,ped_count,bike_count,mvo_count,inj, ped, bike, mvo))
